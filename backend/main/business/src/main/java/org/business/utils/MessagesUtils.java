...
/**
 * MessagesUtils : class qui permet de construire un message depuis
...
public final class MessagesUtils {
	...
	/** Le logger. */
	private static final Log LOGGER = LogFactory.getLog(MessagesUtils.class);
	...
	public static void setClassLoader(ClassLoader classLoader) {
		MessagesUtils.classLoader = classLoader;
	}
	...
	private static String getMessage(String messageKey, Locale newLocale) {
		...
		if (result == null) {
			...
			LOGGER.warn(KEY_NOT_FOUND + messageKey);
